    ...
    <Card
      ...
      <Group
        ...
        <div>
          <Title
            order={2}
            style={{ color: theme.other.text, marginBottom: "8px" }}>
            <ThemeIcon
              color="blue"
              size="lg"
              radius="xl"
        ...
        {planData.bmi && (
          <div style={{ textAlign: "center" }}>
            <RingProgress
              ...
              sections={[
                {
                  value: Math.min(planData.bmi * 2, 100),
                  color:
                    planData.bmi < 25
                      ? "green"
                      : planData.bmi < 30
        ...
        <Card
                    ...
                    <div style={{ flex: 1 }}>
                      <div
                        ...
                        {exercise.media &&
                          exercise.media.gif &&
                          (() => {
                            const fullUrl = `${baseUrl}${exercise.media.gif}`;
                            console.log("Workspace GIF URL:", fullUrl);
                            return (
                              <div
                                style={{
                                  display: "flex",
          ...
          {plan.tips && Array.isArray(plan.tips) && plan.tips.length > 0 && (
            <>
              ...
              <Title
                order={4}
                style={{ color: theme.other.text, marginBottom: "12px" }}>
                <ThemeIcon
                  color="yellow"
                  size="lg"
                  radius="xl"
          ...
          <div
            ...
            {workspaceContent.map((content, index) => (
              <div
                ...
                style={{
                  borderBottom:
                    index < workspaceContent.length - 1
                ...
                !content.response.missing_info ? (
                  ...
                  <Text
                    style={{ whiteSpace: "pre-wrap", color: theme.other.text }}>
                    {typeof content.response === "object" &&
                    content.response.missing_info
                      ? content.response.missing_info
